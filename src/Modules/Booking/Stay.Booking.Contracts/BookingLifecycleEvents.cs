...
/// <summary>Raised when a held booking is confirmed (inventory committed: held → sold). Drives the confirmation notification.</summary>
public sealed record BookingConfirmed(Guid EventId, long BookingId, string Reference, DateTimeOffset OccurredAt)
    : IIntegrationEvent
{
